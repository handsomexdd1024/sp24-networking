<template>
  <div>
    ...
    <div class="operation">
      ...
      <el-button type="danger" plain @click="delBatch" v-if="user.role ==='SUPERVISOR'">批量删除</el-button>
    </div>
      ...
      <el-table :data="tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="center" width="180">
          <template v-slot="scope">
            ...
            <el-button size="mini" type="danger" v-if="user.role ==='SUPERVISOR'" plain @click="del(scope.row.id)" >删除</el-button>
          </template>
        </el-table-column>
      </el-table>
